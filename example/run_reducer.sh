...
./ex_reducer -job="reducer test" -type=c -azureAccountKey=$azureAccountKey > www.txt&

# need to wait for controller to setup
sleep 2
./ex_reducer -job="reducer test" -type=t -azureAccountKey=$azureAccountKey > www1.txt &
./ex_reducer -job="reducer test" -type=t -azureAccountKey=$azureAccountKey > www2.txt &
./ex_reducer -job="reducer test" -type=t -azureAccountKey=$azureAccountKey > www3.txt &
./ex_reducer -job="reducer test" -type=t -azureAccountKey=$azureAccountKey > www4.txt &
